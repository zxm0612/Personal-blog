...
module.exports = {
    publicPath: process.env.NODE_ENV === 'production'//注意：vue3.0后废除了baseUrl，应该改写为publicPath打包才能成功，要不然会报错
    ? './'
    : '/',
    ...
    devServer: {
            ...
            proxy: {//配置跨域
                '/api': {
                    target: 'http://jsonplaceholder.typicode.com/posts',//这里后台的地址模拟的;应该填写你们真实的后台接口
                    ws: true,
